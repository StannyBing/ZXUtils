...
public class ZXNetworkUtil {
     ...
     * @return 网络类型
     * <ul>
     * <li>{@link ZXNetworkUtil.NetworkType#NETWORK_WIFI   } </li>
     * <li>{@link ZXNetworkUtil.NetworkType#NETWORK_4G     } </li>
     * <li>{@link ZXNetworkUtil.NetworkType#NETWORK_3G     } </li>
     * <li>{@link ZXNetworkUtil.NetworkType#NETWORK_2G     } </li>
     * <li>{@link ZXNetworkUtil.NetworkType#NETWORK_UNKNOWN} </li>
     * <li>{@link ZXNetworkUtil.NetworkType#NETWORK_NO     } </li>
     * </ul>
     */
